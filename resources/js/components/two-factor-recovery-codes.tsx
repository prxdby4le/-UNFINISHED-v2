    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Os códigos de recuperação permitem que você recupere o acesso se perder seu
                    dispositivo 2FA. Armazene-os em um gerenciador de senhas seguro.
                </CardDescription>
            </CardHeader>
            <CardContent>
                            ...
                            <>
                                ...
                                <div className="text-xs text-muted-foreground select-none">
                                    <p id="regenerate-warning">
                                        ...
                                        acessar sua conta e será removido
                                        após o uso. Se precisar de mais, clique em{' '}
